                ...
                <div className='flex justify-between w-[100%]'>
                  {errors.agentIdNum1?.type === 'required' &&
                    ...
                    <div className="flex w-[100%] justify-start h-[15px] mb-1">
                      <span className="md:text-[20px] text-[12px] font-normal font-['suit'] tracking-[-3%] not-italic text-left text-red-500">
                        주민등록번호를 입력해주세요
                      </span>
                    </div>
                    ) : (
                ...
                <div className="flex flex-row gap-[5%]">
                  ...
                  <div className='relative w-[45%] h-[40px]'>
                    <input
                      ...
                      maxLength={7}
                      className="border border-gray-300 focus:outline-2 focus:outline-myBlue rounded-md md:text-[20px] text-[16px] font-semibold leading-[150%] tracking-[-1%] font-['suit'] not-italic h-[40px] px-2 w-[100%] text-center"
