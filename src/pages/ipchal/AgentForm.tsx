    ...
    <div id='box' className="flex w-screen bg-mybg justify-center relative">
      <div className="flex flex-col gap-4 w-[100%] h-[100%] bg-mybg items-center text-center relative">
        <div className="flex flex-col gap-2 justify-center items-center md:pt-[100px] pt-[50px]">
          ...
          <span className="md:text-[0.9rem] text-[0.8rem] font-semibold font-['suit'] not-italic text-left text-red-500">
            (* 표시는 필수 입력사항입니다.)
          </span>
        </div>
            ...
            <div className="flex flex-row w-[100%] gap-[5%]">
              <div className="flex flex-col w-[47.5%] gap-1">
                ...
                <input
                  ...
                  id="agentName"
                  type="text"
                  className="border border-gray-300 focus:outline-2 focus:outline-myBlue rounded-md md:text-[0.9rem] text-[0.8rem] font-semibold font-['suit'] not-italic text-left h-[40px] px-2"
            ...
            <div className="flex flex-col w-[100%] gap-1">
              ...
              <div className="flex flex-row gap-[0.5%]">
                <input
                  ...
                  maxLength={3}
                  placeholder="010"
                  className="border border-gray-300 focus:outline-2 focus:outline-myBlue rounded-md md:text-[0.9rem] text-[0.8rem] font-semibold font-['suit'] not-italic h-[40px] px-2 w-[33%] text-center"
            ...
            <div className="flex flex-col w-[100%] gap-1">
                  ...
                  (
                    ...
                    <div className='flex flex-row justify-between w-[100%]'>
                      <div className='flex flex-row justify-start'>
                        <label htmlFor="bidIdNum" className="text-[11pt] font-semibold font-['suit'] not-italic text-left">
                          주민등록번호
                        </label>
                        <span className="text-[1rem] font-semibold font-['suit'] not-italic text-left text-red-500">
                          *
              ...
              <div className="flex flex-row gap-[5%] relative">
                <input
                  ...
                  type="text"
                  maxLength={6}
                  className="border border-gray-300 focus:outline-2 focus:outline-myBlue rounded-md md:text-[0.9rem] text-[0.8rem] font-semibold font-['suit'] not-italic h-[40px] px-2 w-[45%] text-center"
                ...
                <input
                  ...
                  maxLength={7}
                  className="flex justify-center items-center border border-gray-300 focus:outline-2 focus:outline-myBlue rounded-md md:text-[0.9rem] text-[0.8rem] font-semibold font-['suit'] not-italic   h-[40px] px-2 w-[45%] text-center"
                ...
                <div className='flex justify-between w-[100%]'>
                  ...
                  (
                    ...
                    <div className='flex w-[100%] justify-start'>
                      <label
                        htmlFor="agentJob"
                        className="text-[1ren] font-semibold font-['suit'] not-italic text-left"
                      >
                        직업
                      </label>
                      <span className="text-[1rem] font-semibold font-['suit'] not-italic text-left text-red-500">
