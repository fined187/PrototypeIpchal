            ...
            <div className="flex cursor-pointer relative">
              <div className="flex relative">
                <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="-0.00610352" y="0.392578" width="39.7266" height="39.7266" rx="5" fill="#4C61CF"/>
                </svg>
                <div className="flex absolute top-[7px] left-[8px] z-10">
                  <svg xmlns="http://www.w3.org/2000/svg" width="23" height="11" viewBox="0 0 23 11" fill="none">
                    <path d="M20.8916 0.518555H2.823C1.71843 0.518555 0.822998 1.41398 0.822998 2.51855V3.68411C0.822998 4.39928 1.20487 5.06002 1.82453 5.41705L10.8588 10.6223C11.4769 10.9784 12.2377 10.9784 12.8558 10.6223L21.8901 5.41705C22.5097 5.06002 22.8916 4.39928 22.8916 3.68411V2.51855C22.8916 1.41398 21.9962 0.518555 20.8916 0.518555Z" fill="white"/>
                  </svg>
                </div>
                <div className="flex absolute top-[10px] left-[8px]">
                  <svg width="23" height="16" viewBox="0 0 23 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.822998" y="0.518555" width="22.0686" height="15.4751" rx="2" fill="#BFC8F5"/>
                  </svg>
                </div>
              </div>
            </div>
