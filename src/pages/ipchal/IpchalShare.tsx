    ...
    <>
      <div id='box' className="flex w-[100%] justify-center bg-white relative">
        <div className="flex flex-col gap-4 md:w-[50%] w-[100%] h-[100%] bg-mybg items-center text-center md:pt-[100px] pt-[50px]">
          ...
          <div className="flex flex-col gap-10 md:w-[550px] w-[90%] h-[257px] bg-white mt-[30px] justify-center items-center rounded-lg border-slate-500">
            <div className="flex justify-between w-[80%]">
              <div className="flex justify-start items-center w-[80%]">
                <span className="text-black text-center font-NanumGothic text-[1rem] font-extrabold leading-[13px]">
                  아니요
                </span>
              </div>
              <div
