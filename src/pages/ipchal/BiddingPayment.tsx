          ...
          <div className={`flex flex-col md:w-[270px] w-[50%] h-[100%] border border-gray-300 justify-center gap-[10px] ${biddingForm.bidWay === 'M' ? 'bg-mySelect' : 'bg-white'}`} onClick={async () => {
            ...
            <div className={`flex justify-center items-center w-[100%] cursor-pointer ${biddingForm.bidWay === 'M' ? 'bg-mySelect' : 'bg-white'}`}>
              <svg width="105" height="115" viewBox="0 0 105 115" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 70.3761C2 68.0159 3.92983 66.1026 6.31039 66.1026H23.552C25.9325 66.1026 27.8623 68.0159 27.8623 70.3761V108.838C27.8623 111.198 25.9325 113.111 23.552 113.111H6.31039C3.92983 113.111 2 111.198 2 108.838V70.3761Z" fill={`${biddingForm.bidWay === 'M' ? '#F5F5FF' : 'white'}`} />
                ...
                <path d="M59 42V31.737C59 30.1396 60.7803 29.1869 62.1094 30.0729L65.3514 32.2343C66.0428 32.6952 66.9471 32.6806 67.6233 32.1976L70.3375 30.2589C71.6613 29.3134 73.5 30.2596 73.5 31.8864V42" stroke="#8E8EA9" stroke-width="3" stroke-linecap="round"/>
                <path d="M42 25V14.737C42 13.1396 43.7803 12.1869 45.1094 13.0729L48.3514 15.2343C49.0428 15.6952 49.9471 15.6806 50.6233 15.1976L53.3375 13.2589C54.6613 12.3134 56.5 13.2596 56.5 14.8864V20" stroke="#8E8EA9" stroke-width="3" stroke-linecap="round"/>
              </svg>
            </div>
