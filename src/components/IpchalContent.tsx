    ...
    <>
      ...
      {biddingInfo.bidName.length > 1 && (
        <div className="flex flex-col bg-mybg w-[100%] h-[800px] max-h-[4000px] justify-center items-center mx-auto relative overflow-y-scroll scrollbar-hide">
          <div className="w-[100%] md:max-w-[850px] overflow-x-scroll absolute top-[0px] h-[600px] bg-mybg scrollbar-hide">
            <div className="border border-black text-[1.5rem] md:w-[800px] w-[100%] h-[100%] m-auto bg-mybg">
              {/* 첫 번째 박스 */}
              <div className="flex flex-col border-black border-b-[1px] h-[15%] w-[100%] justify-center items-center relative">
                <div className="absolute left-[0px] top-0 pl-[5px]">
                  <span className="text-left md:text-[11pt] text-[10px] leading-[-1px]">
                    (앞면)
                  </span>
                </div>
              ...
              <div className="flex flex-col gap-[10px] justify-start w-[100%] ml-2 absolute top-[350px]">
                ...
                <div className="flex flex-row w-[100%] sm:gap-[115px] gap-[150px] ">
                  ...
                  <span className="md:text-[12pt] text-[12px] text-red-500 font-bold font-batang">
                    {parseInt(biddingInfo.mulgunNum)}
                  </span>
                </div>
          ...
          {/* 공동입찰자 목록 */}
          <div className="flex bg-mybg w-[100%] h-[800px] justify-center items-center mx-auto overflow-y-scroll scrollbar-hide absolute top-[1600px]">
            ...
            <div className="flex w-[100%] md:w-[90%] h-[800px] border border-black absolute top-[150px]">
              ...
              <div className="flex flex-col w-[100%]">
                <div className="flex flex-row w-[100%] h-[50px] border-black border-b-[1px] justify-start items-center">
                  ...
                  <div className="flex flex-col h-[100%] w-[60%] border-black border-r-[1px] justify-center items-center">
                  ...
                  <div className={`flex flex-row w-[100%] h-[75px] border-black ${idx === 9 ? '' : 'border-b-[1px]'} justify-start items-center text-center`} key={idx}>
                    ...
                    <div className="flex flex-col w-[60%] h-[100%] border-black border-r-[1px]">
                      <div className="flex border-black border-b-[1px] w-[100%] h-[50%] justify-center items-center text-center">
                        <span className="md:text-[12pt] text-[12px] font-batang text-wrap">
          ...
          <div className="fixed w-[40%] justify-center items-center text-center bg-mygold rounded-md h-[4%] cursor-pointer top-[80%]" onClick={() => {
            onClose()
          }}>
