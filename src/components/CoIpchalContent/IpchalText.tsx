export default function IpchalText() {
  return (
    <div className="flex flex-col min-w-[400px] md:w-[800px] absolute top-[820px]">
      <span className="text-[20px] font-extrabold font-NanumGothic ">
        주의사항
      </span>
      ...
      <span className="text-[14px] font-NanumGothic font-extrabold underline">
        5. 입찰가격은 수정할 수 없으므로, 수정을 요하는 때에는 새 용지를 사용하십시오.
      </span>
      <p className="text-[12px] font-NanumGothic">
