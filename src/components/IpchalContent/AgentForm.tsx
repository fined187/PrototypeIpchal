...
export default function AgentForm({ totalResult }: { totalResult: GetBiddingInfoType}) {
  ...
  return (
    <div className="flex flex-col bg-mybg min-h-[1500px] max-h-[2000px] md:w-full min-w-[420px] m-auto justify-center items-center relative border-black border-dashed border-t-[2px] overflow-x-scroll">
      ...
      <div className="flex flex-col w-[800px] h-[1000px] items-center text-center absolute top-[50px]">
        <span className="text-[22px] font-extrabold font-nanum">
          위임장
        </span>
        <div className="flex flex-row w-[800px] h-[200px] border-black border-[2px] mt-[20px]">
      ...
      <div className="flex flex-col gap-[50px] w-[800px] justify-center items-center text-center h-[300px] mt-[50px]">
      ...
      {totalResult && totalResult?.bidders.map((_, index) => {
        return (
          <div key={index} className="flex w-[800px] h-[200px] border-black border-[2px]">
            <div className="flex w-[30px] justify-center items-center text-center border-black border-r-[1px]">
              <p className="text-[16px]">
                본인
                <br />
      ...
      <div className="flex flex-col justify-center items-center text-center gap-[50px] w-[800px] h-[200px] mt-[50px]">
        <span>
          * 본인의 인감 증명서 첨부
        </span>
        <span>
