								...
								<div className="flex relative">
									<div>
										<svg width="20" height="20" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
											<circle cx="5.09865" cy="5.23146" r="3.84084" stroke="#C39A28"/>
										</svg>
									</div>
									<div className="flex absolute top-0 left-1">
										<svg width="15" height="15" viewBox="0 0 10 9" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M9.08879 1.26965C8.49937 2.0671 5.06283 5.89755 3.74544 7.69235L0.55957 3.03791" stroke="#C39A28" strokeLinecap="round"/>
										</svg>
									</div>
								</div>
							</div>
