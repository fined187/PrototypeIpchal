...
export default function SinglePDF({ totalResult, handlePrice, handleDepositPrice }: SingleProps) {
  ...
  return (
    // <div className={`flex flex-col bg-white ${totalResult && totalResult.agentYn === 'Y' ? 'h-[3900px]' : 'h-[2700px]'} md:w-[50%] w-[800px] mx-auto relative justify-center items-center`} id="wrap-capture">
    //   <div className="flex flex-col h-[100%] w-[100%] justify-center items-center relative" id="capture">
        <div id="capture" className="flex flex-col bg-white h-[100%] md:w-[100%] w-[100%] mx-auto relative justify-center items-center">
