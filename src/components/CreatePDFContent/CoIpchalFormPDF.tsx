...
export default function CoIpchalFormPDF({ totalResult }: CoIpchalFormProps) {
  return (
    <div className="flex flex-col bg-white w-[800px] m-auto relative scrollbar-hide" style={{
      height: '1300px',
    }}>
      <div className="flex flex-col bg-white h-[100%] w-[100%] m-auto relative justify-center items-center" style={{
        marginTop: "60px"
      }}>
        <div className="flex flex-col w-[100%] h-[100%] justify-center items-center">
          ...
          <div className="flex absolute top-[800px]">
            <div>
              <span className="text-[12pt]  font-['batang']">
                ※ 1. 공동입찰을 하는 때에는 {" "}
                <span className="text-[12pt] underline underline-offset-1">
