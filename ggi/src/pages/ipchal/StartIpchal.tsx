    ...
    <>
      <div className="flex justify-center relative">
        <div className="flex flex-col md:w-[50%] w-full h-screen bg-white items-center text-center">
          <div className="flex">
            <span className="text-lg font-extrabold font-nanum not-italic">입찰표 작성을 시작합니다</span>
          </div>
          <div className="flex absolute top-16">
            <span className="text-xs text-mygray font-bold font-nanum not-italic">질문에 답변해 주세요.</span>
          </div>
