...
export default function Home() {
  ...
  return (
    <>
      ...
      {stateNum === 1 && <GetIpchalInfo formData={formData} setFormData={setFormData} />}
      {stateNum === 2 && <BidderInfo formData={formData} setFormData={setFormData} />}
      {stateNum === 3 && <BidderCnt formData={formData} setFormData={setFormData} />}
      {stateNum === 4 && <BidderDetail formData={formData} setFormData={setFormData} />}
    </>
  );
}
